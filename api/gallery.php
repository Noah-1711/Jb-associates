...
//?>
    ...
    if(!empty($_POST['image_name']) || !empty($_POST['image_desc']) || $_FILES['file'])
    {
    ...
    //insert form data in the database
    $insert = $connection->query("INSERT INTO tbl_gallery (image_name, image_desc, image_path, status) VALUES ('".$imagename."','".$imagedesc."','".$final_image."','YES')"); 
    //echo $insert?'ok':'err';
